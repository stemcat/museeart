...
import { getPickByDate } from "@/lib/queries";
...
export default async function OpengraphImage({
  ...
  const result = isValidDateParam(date) ? await getPickByDate(date) : null;

  if (!result) return brandCard();
    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 22, color: "#8a8172", marginTop: 8 }}>
            {artwork.dateDisplay ?? ""}
          </div>
